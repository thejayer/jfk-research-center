...
import type { OpenQuestionsArticle } from "@/lib/api-types";
import { formatNumber } from "@/lib/format";

export function OpenQuestionsArticleBody({
  article,
  label = "AI-generated analysis",
}: {
  article: OpenQuestionsArticle;
  label?: string;
}) {
  ...
  const generated = toISODate(article.generatedAt);
