...
type DealeyWitnessSeed = readonly [
  string,
  string,
  number,
  number,
...
const DEALEY_PLAZA_WITNESS_SEEDS: DealeyWitnessSeed[] = [
  [
    "brennan-howard",
    "Howard Brennan",
    32.77925,
    -96.80876,
    "South side of Elm Street, opposite the TSBD",
  ...
  [
    ...
    32.77915,
    -96.80871,
    "South side of Elm Street, near the pergola",
  ...
  [
    ...
    32.77931,
    -96.8087,
    "Concrete pergola, north side of Elm Street",
  ...
  [
    ...
    32.7791,
    -96.80892,
    "South side of Main Street, opposite the grassy knoll",
  ...
  [
    ...
    32.77918,
    -96.80897,
    "South curb of Elm Street near the Z-313 position",
  ...
  [
    ...
    32.77919,
    -96.80895,
    "South curb of Elm Street, with Mary Moorman",
  ...
  [
    ...
    32.77942,
    -96.80889,
    "North curb of Elm Street, near the stockade fence",
  ...
  [
    ...
    32.77985,
    -96.8095,
    "Triple Underpass, atop the railroad bridge",
  ...
  [
    ...
    32.77975,
    -96.8091,
    "Union Terminal railroad tower, behind the grassy knoll",
  ...
  [
    ...
    32.7793,
    -96.80905,
    "North curb of Elm Street, very near the limousine",
  ...
  [
    ...
    32.7801,
    -96.8095,
    "Triple Underpass, south curb of Main Street",
  ...
  [
    ...
    32.77926,
    -96.80906,
    "Front-passenger seat of the presidential limousine",
  ...
  [
    ...
    32.77926,
    -96.80906,
    "Running board of the Secret Service follow-up car",
  ...
  [
    ...
    32.77957,
    -96.80831,
    "5th floor of the TSBD, directly below the sniper window",
  ...
  [
    ...
    32.77963,
    -96.80825,
    "TSBD 2nd-floor lunchroom (per his own statement and Officer Baker)",
  ...
  [
    ...
    32.77963,
    -96.80825,
    "TSBD 2nd-floor lunchroom (entered from outside)",
  ...
  [
    ...
    32.77963,
    -96.80825,
    "TSBD entrance, running upstairs with Officer Baker",
...
export function buildDealeyPlazaResponse(): DealeyPlazaResponse {
  const witnesses: DealeyPlazaWitness[] = DEALEY_PLAZA_WITNESS_SEEDS.map(
    ([
      witnessId,
      name,
      positionLat,
